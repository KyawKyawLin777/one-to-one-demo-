...
public class CustomerService {
    ...
    public Address findAddressById(int id) {
        return addressDao.findById(id).orElseThrow(EntityNotFoundException::new);
    }


    @Transactional
    public void createDb(){
        Customer c1 = new Customer("John","Doe","doe@gmail.com");
        Customer c2 = new Customer("Kyaw","Gyi","kyaw@gmail.com");
        Customer c3 = new Customer("Zaw","Lay","zaw@gmail.com");

        Address address1 = new Address("Love Lane","11111","Yangon");
        Address address2 = new Address("Dream Land","22222","Mandalay");
        Address address3 = new Address("Mingalar Road","33333","Yangon");
